...
{
    [TestClass]
    public class RecommendNotFullPortions_Should
    {
        [TestMethod]
        public void ThrowArgumentException_WhenNutritionisInvalid()
        {
            ...
            //Act&Assert
            Assert.ThrowsException<ArgumentException>(() => recommender.RecommendNotFullPortions(maxCalories, nutrition), "Wrong nutrition name!");
        }
    }
}
